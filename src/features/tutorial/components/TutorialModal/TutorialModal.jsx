        ...
        <div className={styles.backdrop} onClick={this.props.dismissTutorial}></div>
          <div className={styles.content}>
            ...
            <div className={styles.footer}>
              <button onClick={this.props.dismissTutorial} className={`btn btn-primary btn-large ${styles.dismiss}`}>{this.props.dismiss}</button>
              {this.props.button && <Link to={this.props.route}>
                  <button key='showNext' className={`btn btn-primary btn-large ${styles.next}`} onClick={this.props.handleNext}>
                    {this.props.button}
                  </button>
                </Link>}
            </div>
